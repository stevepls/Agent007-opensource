...
Bug Fixes:
- from_dict now creates a copy to avoid mutating the source dict
"""
...
class Todo:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Todo":
        # Create a copy to avoid mutating the source dictionary
        data = data.copy()
...
class TodoManager:
    ...
    def complete(self, todo_id: str, completed_by: str = "human") -> Optional[Todo]:
        ...
        if todo:
            todo.add_note("Completed", completed_by)
            self._save()
        return todo
